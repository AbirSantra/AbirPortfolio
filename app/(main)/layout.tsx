  ...
  return (
    <html lang="en" className="dark">
      <body className="scroll-smooth bg-neutral-50 font-Poppins  text-neutral-950 antialiased transition-all duration-200 ease-linear  dark:bg-neutral-900 dark:text-white ">
        <div className="fixed -z-10 h-full w-full bg-[radial-gradient(#cbcbcba6_1px,transparent_1px)] [background-size:16px_16px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_30%,transparent_100%)] dark:bg-[radial-gradient(#474747a6_1px,transparent_1px)]"></div>
