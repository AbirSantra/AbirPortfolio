...
export const Tooltip = ({ children, text, direction }: Props) => {
  return (
    <div className="group relative inline-block">
      {children}
      <p
        className={`invisible absolute whitespace-nowrap rounded-md bg-white p-2 text-xs text-gray-950 opacity-0 shadow-sm duration-100 ease-linear group-hover:visible group-hover:opacity-100 dark:bg-gray-900 dark:text-white ${
